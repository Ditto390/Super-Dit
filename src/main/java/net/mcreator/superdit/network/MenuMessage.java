...
import net.mcreator.superdit.procedures.MenuOnKeyPressedProcedure;
...
public class MenuMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		SuperDitMod.addNetworkMessage(MenuMessage.class, MenuMessage::buffer, MenuMessage::new, MenuMessage::handler);
	}
}
